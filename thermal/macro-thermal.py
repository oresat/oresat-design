...
delta_t = 240				#time step (in seconds)
num_t	= 1*60*24*4			#number of time steps

face_angle_1 = 0			#see discussion in SMAD; maybe use this to calculate the profile projection of the faces?
face_angle_2 = 0			
...
average_power_generation = 3		#mean power generated by the satellite internally. 3W, approximately.
...
pv_absorptivity = (1-pv_reflectivity)*(1-pv_efficiency)	#absorptivity (using reasonable value for aluminum)
							#equation from "A simplified Thermal Model for Flat-Plate PV Arrays," Fuentes 87
pv_emissivity = 0.85			
pv_area = 90						#area of solar panels on one face, in cm^2

structure_absorptivity = 0.5				#typical value for aluminum
structure_emissivity = 0.2				#rough aluminum
...
projected_area = .01				#projected area of the plate towards the sun, m^2
radiating_area = .06				#radiating area of the plate, m^2
