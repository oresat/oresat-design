...
* ___AX.25 Packet Protocol___
   -- This is the AX.25 digital packet radio beacon sent from the spacecraft on the UHF downlink frequency using 9600 bit/sec G3RUH FSK modulation during 10 minute periodic telemetry times. This emission comes just after the CW beacon.
